...
class WalletServices {
    ...
    // TODO use bundle id
    private let tag = "com.MOT.CryptoRideDriver.keyData"
    ...
    /// TODO allow for mnemonic import 
    /// - Parameters:
    ...
    ///
    func createKeyStore(credentials:Credentials,completion:@escaping(Result<(String,String),KeyStoreServicesError>) -> Void) {
